...
output$bigMap <- renderLeaflet({
 ...
 leaflet(data = map_data())  %>%
  ...
  #  addLegend("bottomleft", pal = palPM10, values = ~`PM10.0_CF_ATM_ug/m3_avg`,
  #   title = "Average PM10.0_CF_ATM_ug/m3",
  #   group = "PM10.0_CF_ATM_ug/m3",
  #   labFormat = labelFormat(suffix = "ug/m3"),
  #   opacity = 1
  # )  %>%
  #  addLegend("bottomleft", pal = palPM25, values = ~`PM2.5_CF_ATM_ug/m3_avg`,
  #   title = "Average PM2.5_CF_ATM_ug/m3",
  #   group = "PM2.5_CF_ATM_ug/m3",
  #   labFormat = labelFormat(suffix = "ug/m3"),
  #   opacity = 1
  # )  %>%
  #  addLegend("bottomleft", pal = palPM251, values = ~`PM2.5_CF_1_ug/m3_avg`,
  #   title = "Average PM2.5_CF_1_ug/m3",
  #   group = "PM2.5_CF_1_ug/m3",
  #   labFormat = labelFormat(suffix = "ug/m3"),
  #   opacity = 1
  # )  %>%
  #  addLegend("bottomleft", pal = palPM1, values = ~`PM1.0_CF_ATM_ug/m3_avg`,
  #   title = "Average PM1.0_CF_ATM_ug/m3",
  #   group = "PM1.0_CF_ATM_ug/m3",
  #   labFormat = labelFormat(suffix = "ug/m3"),
  #   opacity = 1
  # )%>%
  addLayersControl(
